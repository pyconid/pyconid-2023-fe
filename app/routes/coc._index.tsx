          ...
          <div className="mx-auto max-w-3xl text-center">
            <figure>
              ...
              <p className="text-gray-800">
                ...
                individual. By attending PyCon ID 2021, you agree with the Code
                of Conduct.
              </p>
              <br />
              ...
              <ul>
                <li>
                  PyCon ID is a community conference intended for collaboration
                  in the developer community.
                </li>
                <li>
                  We value the participation of each member of the Python
                  community and want all attendees to have an enjoyable and
                  fulfilling experience. Accordingly, all attendees are expected
                  to show respect and courtesy to other attendees throughout the
                  conference and at all conference events, whether officially
                  sponsored by Python ID or not.
                </li>
                <li>
                  To make clear what is expected, all delegates/attendees,
                  speakers, exhibitors, organizers and volunteers at any PyCon
                  event are required to conform to the following Code of
              ...
              <ul>
                <li>
                  ...
                  status, sexual images in public spaces, deliberate
                ...
                <li>
                  Spamming message such as making promotion, giving rude
                  comments, or anything else that can cause any uncomfortable
                  feeling to other participants is also prohibited. Please
                  introduce yourself and be kind when trying to have
                  conversation with other participants. If you are not one of
                  our sponsor member, make sure you have their consent before
                  giving promotion or something like that.
                </li>
                <li>
                ...
                <li>
                  Exhibitors in the expo hall, sponsor or vendor booths, or
                  similar activities are also subject to the anti-harassment
                  policy. In particular, exhibitors should not use sexualized
                  images, activities, or other material. Booth staff (including
                ...
                <li>
                  ...
                  conference with no refund. If you are being harassed, notice
                  that someone else is being harassed, or have any other
                  concerns, please contact a member of conference staff
                  immediately.
                </li>
                <li>
                  Conference staff can be identified by t-shirts/special
                  badges/head sets.
                </li>
                <li>
